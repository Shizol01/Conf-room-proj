...
from main.views import (RoomAddView, HomePageView, RoomsDisplayView, delete_room_view, EditRoomView, ReserveRoom)
...
urlpatterns = [
    ...
    path('room/delete/<int:id>', delete_room_view),
    path('room/modify/<int:id>', EditRoomView.as_view()),

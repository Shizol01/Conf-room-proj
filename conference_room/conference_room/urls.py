...
from main.views import (RoomAddView, HomePageView, RoomsDisplayView, delete_room_view, EditRoomView, ReserveRoom, room_details,search_rooms,)
...
urlpatterns = [
    ...
    path('room/<int:id>', room_details, name='room_detail'),
